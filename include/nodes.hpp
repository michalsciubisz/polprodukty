...
class IPackageReceiver {
    ...
    IPackageStockpile::const_iterator begin() const { return stockpile_.cbegin(); }
    IPackageStockpile::const_iterator cbegin() const { return stockpile_.cbegin(); }
    IPackageStockpile::const_iterator end() const { return stockpile_.cend(); }
    IPackageStockpile::const_iterator cend() const { return stockpile_.cend(); }
};
